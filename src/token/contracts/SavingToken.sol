...
contract BLOXAB is ERC721 {
    ...
    string public constant NAME = "BLOXABLEB"; // solhint-disable-line
    string public constant SYMBOL = "BLXB"; // solhint-disable-line
    ...
    function createBond(address _owner,address[] _contracts, string _rating, string _name, uint256 _price) public onlyCOO {
        ...
        promoCreatedCount++;
        _createBond(_name,  _rating,_contracts,personOwner, _price);
    }

    /// @dev Creates a new Pgeterson with the given name.
    // function createContractPerson(string _name) public onlyCOO returns (bool){
    ...
    function purchase(uint256 _tokenId) public payable {
        ...
        TokenSold(_tokenId, sellingPrice, personIndexToPrice[_tokenId], oldOwner, newOwner, bonds[_tokenId].name);
    ...
    /// For creating Person
    function _createBond(string _name, string _rating, address[] _contracts, address _owner, uint256 _price) private {
        ...
        uint256 newPersonId = bonds.push(_bond) - 1;
